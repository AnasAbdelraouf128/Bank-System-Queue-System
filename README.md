...
C:\Users\Anas\Projects\Bank-Queue-System> java Main
================================================
       نظام إدارة طوابير البنك الذكي
       Bank Queue Management System
================================================

--- القائمة الرئيسية ---
1. إضافة عميل جديد للطابور (Enqueue)
2. خدمة العميل التالي (Dequeue)
3. عرض حالة الطابور الحالي
4. خروج من النظام
------------------------
> اختر عملية (1-4): 1

[إضافة عميل]
أدخل اسم العميل: أحمد علي
>> تم بنجاح: إضافة العميل (أحمد علي) إلى الطابور. رقم التذكرة: A001

------------------------
> اختر عملية (1-4): 1

[إضافة عميل]
أدخل اسم العميل: سارة محمد
>> تم بنجاح: إضافة العميل (سارة محمد) إلى الطابور. رقم التذكرة: A002

------------------------
> اختر عملية (1-4): 1

[إضافة عميل]
أدخل اسم العميل: خالد عمر
>> تم بنجاح: إضافة العميل (خالد عمر) إلى الطابور. رقم التذكرة: A003

------------------------
> اختر عملية (1-4): 3

[حالة الطابور الحالي]
عدد العملاء في الانتظار: 3
[بداية الطابور] -> (أحمد علي - A001) -> (سارة محمد - A002) -> (خالد عمر - A003) -> [نهاية الطابور]

------------------------
> اختر عملية (1-4): 2

[خدمة عميل]
>> جاري خدمة العميل الآن: (أحمد علي - صاحب التذكرة A001)
تمت إزالة العميل من قائمة الانتظار.

------------------------
> اختر عملية (1-4): 3

[حالة الطابور الحالي]
عدد العملاء في الانتظار: 2
[بداية الطابور] -> (سارة محمد - A002) -> (خالد عمر - A003) -> [نهاية الطابور]

------------------------
> اختر عملية (1-4): 2

[خدمة عميل]
>> جاري خدمة العميل الآن: (سارة محمد - صاحب التذكرة A002)
تمت إزالة العميل من قائمة الانتظار.

------------------------
> اختر عملية (1-4): 4

جاري إغلاق النظام... شكراً لاستخدامكم برنامجنا.

C:\Users\Anas\Projects\Bank-Queue-System>
